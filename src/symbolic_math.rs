...
pub fn symbolic_factorial(n: u32) -> Vec<u8> {
    ...
    for i in 2..=n {
        cur_product = symbolic_multiply(&cur_product, &num_to_symbolic_num(i.into()));
    }
    cur_product
}
...
mod tests {
    ...
    fn test_single_digit_symbolic_multiply() {
        ...
        assert_eq!(
            single_digit_symbolic_multiply(&multiplier, multiplicand),
            vec![b'8', b'8', b'2']
        );
    ...
    fn test_symbolic_multiply() {
        ...
        assert_eq!(
            symbolic_multiply(&multiplier, &multiplicand),
            vec![b'7', b'4', b'4', b'8']
        );
    ...
    fn test_num_to_symbolic_num() {
        let num = 93534;
        assert_eq!(num_to_symbolic_num(num), vec![b'9', b'3', b'5', b'3', b'4']);
    }

    #[test]
    fn test_symbolic_factorial() {
        assert_eq!(symbolic_factorial(10), num_to_symbolic_num(3628800));
    }

    #[test]
    fn test_sum_symbolic_digits() {
        assert_eq!(sum_symbolic_digits(&num_to_symbolic_num(12345)), 15);
    }
}
